...
/*!
  ...
  \sa show
*/
TrayIcon::TrayIcon( QObject *parent, const char * )
...
/*!
  ...
  \sa show
*/
TrayIcon::TrayIcon( const QPixmap &icon, const QString &tooltip, QPopupMenu *popup, QObject *parent, const char * )
...
#ifdef WIN32
#include <trayicon_win.cpp>
#endif
#ifdef Q_OS_MACX 
#include <trayicon_mac.cpp>
#endif
#ifdef Q_WS_X11
#include <trayicon_x11.cpp>
#endif
